...
The short-term milestone is a browser-capable renderer proof: the same permanent torture scene should run under native Mobile and the WebGPU Mobile backend before vehicle work becomes large.
